    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (e.code === "auth/popup-closed-by-user") {
                setError(null); // 使用者關閉彈窗，不顯示錯誤
            } else if (e.message?.includes("未授權")) {
                setError("此帳號未被授權，請聯繫管理員。");
            } else {
    ...
    return (
        <div className="login-container">
            <div className="login-card">
                ...
                <h1 className="login-title">康 Core</h1>
                <p className="login-subtitle">AI 個人助理儀表板</p>
